...
const index = () => {
 ...
 onClick={() => router.push(`/chat/${process.env.NEXT_PUBLIC_GROUP_ID}`)} >
          ...
          <button             className="border border-indigo-600 bg-black text-white rounded-lg p-4 font-semibold mb-[1.5rem]"
 onClick={() => router.push(`/chat/${process.env.NEXT_PUBLIC_GROUP_ID}`)} >
            <a href="https://www.footprint.network/research/gamefi/game-protocols/single-game-stats?chain=Ethereum&series_date-79426=past90days&game_name=Pixels">DAO Analytics</a>
          </button>
        </Box>
      </Flex>
    )}
